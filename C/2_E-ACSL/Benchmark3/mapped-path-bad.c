...
$Author: mc2zk $
$Date: 2008/02/29 20:31:47 $
$Header: /home/zephyr/zephyr-cvs/buffer_overflow_bench_models/wu-ftpd/f1/mapped-path-bad.c,v 1.1.1.1 2008/02/29 20:31:47 mc2zk Exp $
...
#endif
{
	...
	printf("ALERT: mapped_path[MAXPATHLEN] has been overflowed!\n");
      ...
      // JS: comment this check to activate the last bad behavior      
